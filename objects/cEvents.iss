objectdef cEvents inherits cBase
{
	...
	method Register()
	{
			...
			LavishScript:RegisterEvent[Twisted_CONFIG_XBOX]			
			LavishScript:RegisterEvent[Twisted_CONFIG_SLIDER]
			LavishScript:RegisterEvent[Twisted_CONFIG_COMBO]			
			...
			Event[Twisted_CONFIG_XBOX]:AttachAtom[Config:UpdateCheckBox]
			Event[Twisted_CONFIG_SLIDER]:AttachAtom[Config:UpdateSlider]
			Event[Twisted_CONFIG_COMBO]:AttachAtom[Config:UpdateCombo]			
