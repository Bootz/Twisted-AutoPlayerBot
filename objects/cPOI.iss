...
objectdef oPOI inherits cBase
{
  ...
  {               
	...
	method RemovePOI()
	{
		variable string POITYPE = ${UIElement[cmbPOIsType@Blacklist@POIPages@POIs@Pages@Twisted].SelectedItem}
		variable string DelFQN=${UIElement[tlbPOIs@Blacklist@POIPages@POIs@Pages@Twisted].SelectedItem}
	...
	{
		variable string POITYPE = ${UIElement[cmbPOIsType@Blacklist@POIPages@POIs@Pages@Twisted].SelectedItem}
		variable string GotoFQN=${UIElement[tlbPOIs@Blacklist@POIPages@POIs@Pages@Twisted].SelectedItem}
	...
	{
		if ${UIElement[tlbPOIs@Blacklist@POIPages@POIs@Pages@Twisted].SelectedItem(exists)}
		{
			variable string myval=${UIElement[tlbPOIs@Blacklist@POIPages@POIs@Pages@Twisted].SelectedItem}
	...
	{
		if ${UIElement[tlbPOIsBL@Blacklist@POIPages@POIs@Pages@Twisted].SelectedItem(exists)}
		{
			variable string myval=${UIElement[tlbPOIsBL@Blacklist@POIPages@POIs@Pages@Twisted].SelectedItem}
	...
	{
		if ${UIElement[tenManualBL@Blacklist@POIPages@POIs@Pages@Twisted].Text(exists)}
		{
			variable string myval=${UIElement[tenManualBL@Blacklist@POIPages@POIs@Pages@Twisted].Text}
			GlobalBlacklist:Insert[${myval.Upper},-1]
			UIElement[tenManualBL@Blacklist@POIPages@POIs@Pages@Twisted]:SetText[]
		}
		This:PopulatePOIs
	}
	...
	{
		variable string POITYPE = ${UIElement[cmbPOIsType@Blacklist@POIPages@POIs@Pages@Twisted].SelectedItem}
		UIElement[tlbPOIsBL@Blacklist@POIPages@POIs@Pages@Twisted]:ClearItems
		UIElement[tlbPOIs@Blacklist@POIPages@POIs@Pages@Twisted]:ClearItems
			...
			if ${BlacklistIterator:First(exists)}				
			{
				do
				{
					if ${BlacklistIterator.Value} == -1
					{
						...
						UIElement[tlbPOIsBL@Blacklist@POIPages@POIs@Pages@Twisted]:AddItem[${BlacklistedItem.Lower}]				
					}
				}
		...
		if ${POITYPE.NotEqual[NULL]}
		{
			...
			POIFOUND:Set[${LNavRegionGroup[${UIElement[cmbPOIsType@Blacklist@POIPages@POIs@Pages@Twisted].SelectedItem}].RegionsWithin[MerchantPOI,100000,${Me.X},${Me.Y},${Me.Z}]}]
			while ${MerchantPOI.Get[${Index:Inc}](exists)}
			{
				if ${GlobalBlacklist.Exists[${MerchantPOI.Get[${Index}].FQN}]}
				{
					if ${Navigator.AvailablePath[${MerchantPOI.Get[${Index}].Region.CenterPoint.X},${MerchantPOI.Get[${Index}].Region.CenterPoint.Y},${MerchantPOI.Get[${Index}].Region.CenterPoint.Z}]}
					{
						UIElement[tlbPOIsBL@Blacklist@POIPages@POIs@Pages@Twisted]:AddItem[${MerchantPOI.Get[${Index}].FQN.Upper}]
					}
					else
					{
						UIElement[tlbPOIsBL@Blacklist@POIPages@POIs@Pages@Twisted]:AddItem[${MerchantPOI.Get[${Index}].FQN.Lower}]
					}
				}
				else
				{
					if ${Navigator.AvailablePath[${MerchantPOI.Get[${Index}].Region.CenterPoint.X},${MerchantPOI.Get[${Index}].Region.CenterPoint.Y},${MerchantPOI.Get[${Index}].Region.CenterPoint.Z}]}
					{
						UIElement[tlbPOIs@Blacklist@POIPages@POIs@Pages@Twisted]:AddItem[${MerchantPOI.Get[${Index}].FQN.Upper}]
					}
					else
					{
						UIElement[tlbPOIs@Blacklist@POIPages@POIs@Pages@Twisted]:AddItem[${MerchantPOI.Get[${Index}].FQN.Lower}]
					}
				}
				...
				if ${GlobalBlacklist.Exists[${LNavRegionGroup["${POITYPE}"].NearestRegion[${MerchantPOI.Get[${Index}].Region.CenterPoint.X},${MerchantPOI.Get[${Index}].Region.CenterPoint.Y},${MerchantPOI.Get[${Index}].Region.CenterPoint.Z}].Custom[GUID]}]}
				{
					if ${Navigator.AvailablePath[${MerchantPOI.Get[${Index}].Region.CenterPoint.X},${MerchantPOI.Get[${Index}].Region.CenterPoint.Y},${MerchantPOI.Get[${Index}].Region.CenterPoint.Z}]}
					{
						UIElement[tlbPOIsBL@Blacklist@POIPages@POIs@Pages@Twisted]:AddItem[${LNavRegionGroup["${POITYPE}"].NearestRegion[${MerchantPOI.Get[${Index}].Region.CenterPoint.X},${MerchantPOI.Get[${Index}].Region.CenterPoint.Y},${MerchantPOI.Get[${Index}].Region.CenterPoint.Z}].Custom[GUID].Upper}]
					}
					else
					{
						UIElement[tlbPOIsBL@Blacklist@POIPages@POIs@Pages@Twisted]:AddItem[${LNavRegionGroup["${POITYPE}"].NearestRegion[${MerchantPOI.Get[${Index}].Region.CenterPoint.X},${MerchantPOI.Get[${Index}].Region.CenterPoint.Y},${MerchantPOI.Get[${Index}].Region.CenterPoint.Z}].Custom[GUID].Lower}]
					}
				}
			}
		}
