...
GreyNav:LoadMacroPathContinent[0, C:\\navdata\\Azeroth\\Azeroth_MacroPath_NavRegions.bin2]
	...
	method OnGUIChange()
	{
		This.MappingDisabled:Set[${UIElement[chkMappingOff@Overview@Pages@Twisted].Checked}]
		This.MapPathway:Set[${UIElement[chkMapPathway@Overview@Pages@Twisted].Checked}]
		This.MapPathwayReverse:Set[${UIElement[chkMapPathwayReverse@Overview@Pages@Twisted].Checked}]		
	}
