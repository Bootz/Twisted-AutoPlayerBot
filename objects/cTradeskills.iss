...
;---------------------------
	...
	{
		if ${Spell["First Aid"](exists)} && ${UIElement[MakeBandages@TradeSkills@InvPages@Inventory@Pages@Twisted].Checked} && !${Toon.Sitting}
		{
...
;--------------
	...
	{
		if ${Spell["Disenchant"](exists)} && ${UIElement[chkAutoDE@TradeSkills@InvPages@Inventory@Pages@Twisted].Checked} && !${Toon.Sitting}
		{
...
;------------------
	...
	{
		if ${UIElement[MakeBandages@TradeSkills@InvPages@Inventory@Pages@Twisted].Checked} && !${Toon.Sitting}
		{
			This.BandList:Search[-items,-inventory,Bandage]
			if ${This.BandList.Count} == 0 && !${This.makeableBandage[2].Equal["NONE"]}
			{
