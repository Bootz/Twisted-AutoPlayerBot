objectdef cToon inherits cBase
{
	...
	member PullRange()
	{
		variable int maxrange = ${UIElement[cmbPullRange@Grind@Pages@Twisted].SelectedItem}
		return ${maxrange}
	}
	...
	{
		if ${This.DetectAdds[${MobGUID}]} && !${Me.InCombat} && !${UIElement[chkAssistMode@Overview@Pages@Twisted].Checked} && !${UIElement[chkPartyMode@Overview@Pages@Twisted].Checked}
		{
