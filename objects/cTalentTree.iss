...
objectdef cTalentTreeHandler inherits cBase
{
	...
	variable string TalentTable = "tlbAvailableTalents@Specs@TalentPages@Talents@Pages@Twisted"
	variable string SpecedTable = "tlbSpecedTalents@Specs@TalentPages@Talents@Pages@Twisted"
	variable string SpecList = "tlbSpecs@Management@TalentPages@Talents@Pages@Twisted"
	variable string ChosenSpec = "cmbSpec@Overview@Pages@Twisted"
	variable string SpecPullDown = "cmbSpec@Specs@TalentPages@Talents@Pages@Twisted"
	variable string TreePullDown = "cmbTree@Specs@TalentPages@Talents@Pages@Twisted"
