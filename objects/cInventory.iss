...
objectdef oInventory inherits cBase
{
  ...
  variable int lowestRpairPct = -1
	...
	{
		variable int lfs = ${UIElement[leaveFreeSlots@Config@InvPages@Inventory@Pages@Twisted].SelectedItem.Value}
		return ${lfs}
	}
	
	method lowestRepairPCTSet()
	{
		LavishSettings[Settings]:AddSetting[lowestRepairPCT,${UIElement[lowestRepairPCT@Config@InvPages@Inventory@Pages@Twisted].Text}]
		Inventory.lowestRpairPct:Set[${UIElement[lowestRepairPCT@Config@InvPages@Inventory@Pages@Twisted].Text}]
		This:Output[Set and Saved Lowest Repair % as ${UIElement[lowestRepairPCT@Config@InvPages@Inventory@Pages@Twisted].Text}]
	}
	
	method overAllRepairPCTSet()
	{
		LavishSettings[Settings]:AddSetting[overAllRepairPCT,${UIElement[overAllRepairPCT@Config@InvPages@Inventory@Pages@Twisted].Text}]
		Inventory.overAllRepairPCT:Set[${UIElement[overAllRepairPCT@Config@InvPages@Inventory@Pages@Twisted].Text}]
		This:Output[Set and Saved Overall Repair % as ${UIElement[overAllRepairPCT@Config@InvPages@Inventory@Pages@Twisted].Text}]
	}
	
	;the  MuleCharName is in ${UIElement[tenMuleChar@Config@InvPages@Inventory@Pages@Twisted]}
	method SetMule()
	{
		if ${UIElement[tenMuleChar@Config@InvPages@Inventory@Pages@Twisted].Text.NotEqual[""]}
		{
			This.MuleCharName:Set[${UIElement[tenMuleChar@Config@InvPages@Inventory@Pages@Twisted].Text}]
	...
	method SetFood()
	{
		if ${Target.Name(exists)}
		{
			...
			UIElement[FoodMerchant@Config@InvPages@Inventory@Pages@Twisted]:SetText[${This.FoodMerch}]
	...
	method SetDrink()
	{
		if ${Target.Name(exists)} 
		{
			...
			UIElement[DrinkMerchant@Config@InvPages@Inventory@Pages@Twisted]:SetText[${This.DrinkMerch}]
	...
	method SetAmmo()
	{
		if ${Target.Name(exists)}
		{
			...
			UIElement[AmmoMerchant@Config@InvPages@Inventory@Pages@Twisted]:SetText[${This.AmmoMerch}]
	...
	method SetEnterKey()
	{
		LavishSettings[Settings]:AddSetting[EnterKey,${UIElement[EnterKey@Logout@Pages@Twisted].Text}]
		This:Output[Set and Saved EnterKey as ${UIElement[EnterKey@Logout@Pages@Twisted].Text}]
	}
	method SetAccountName()
	{
		LavishSettings[Settings]:AddSetting[AccountName,${UIElement[AccountName@Logout@Pages@Twisted].Text}]
		This:Output[Set and Saved AccountName as ${UIElement[AccountName@Logout@Pages@Twisted].Text}]
	}
	method SetPassword()
	{
		LavishSettings[Settings]:AddSetting[Password,${UIElement[Password@Logout@Pages@Twisted].Text}]
		This:Output[Set and Saved Password as ${UIElement[Password@Logout@Pages@Twisted].Text}]
	}
	method SetAutoReconnect()
	{
		LavishSettings[Settings]:AddSetting[chkAutoReconnect,${UIElement[chkAutoReconnect@Logout@Pages@Twisted].Checked}]
	}
	...
	member SellRarity()
	{
		variable int rarity = ${UIElement[cmbAutoSell@Config@InvPages@Inventory@Pages@Twisted].SelectedItem.Value}
		return ${rarity}
	}
	
	member MuleRarity()
	{
		variable int rarity = ${UIElement[cmbAutoMule@Config@InvPages@Inventory@Pages@Twisted].SelectedItem.Value}
		if ${rarity}==0
		{
			return 99
		}
 ...
 */
 ...
 ; GUI Update Methods
	...
	method UpdateListed(string theList,int theColor)
	{
		...
		while ${iter.IsValid}
		{
			UIElement[lstListed@Items@InvPages@Inventory@Pages@Twisted]:AddItem[\[${theList}\]${iter.Key},${theColor}]			
			iter:Next
		}
	}
	method UpdateNotListed()
	{
		...
		while ${iter.IsValid}
		{
			UIElement[lstInventory@Items@InvPages@Inventory@Pages@Twisted]:AddItem[${iter.Key}]
			iter:Next
		}
	}
	...
	{
		UIElement[lstListed@Items@InvPages@Inventory@Pages@Twisted]:ClearItems
		UIElement[lstInventory@Items@InvPages@Inventory@Pages@Twisted]:ClearItems
	...
	method Add(string theList)
 	{
 		if ${UIElement[lstInventory@Items@InvPages@Inventory@Pages@Twisted].SelectedItem(exists)}
		{
			${theList}List:Add[${UIElement[lstInventory@Items@InvPages@Inventory@Pages@Twisted].SelectedItem.Text}]
			List:Remove[${UIElement[lstInventory@Items@InvPages@Inventory@Pages@Twisted].SelectedItem.Text}]
			This:UpdateItemsGUI
		}
 	}
 	method Delete()
 	{
 		...
 		if ${UIElement[lstListed@Items@InvPages@Inventory@Pages@Twisted].SelectedItem(exists)}
		{
			TextColor:Set[${UIElement[lstListed@Items@InvPages@Inventory@Pages@Twisted].SelectedItem.Value}]
			switch ${TextColor}
			{
				case INV_SELL		
				SellList:Remove[${UIElement[lstListed@Items@InvPages@Inventory@Pages@Twisted].SelectedItem.Text.Mid[7,100]}]
				break
				case INV_KEEP
				KeepList:Remove[${UIElement[lstListed@Items@InvPages@Inventory@Pages@Twisted].SelectedItem.Text.Mid[7,100]}]
				break
				case INV_MULE
				MuleList:Remove[${UIElement[lstListed@Items@InvPages@Inventory@Pages@Twisted].SelectedItem.Text.Mid[7,100]}]
				break
				case INV_BANK
				BankList:Remove[${UIElement[lstListed@Items@InvPages@Inventory@Pages@Twisted].SelectedItem.Text.Mid[7,100]}]
				break
				case INV_DESTROY
				DestroyList:Remove[${UIElement[lstListed@Items@InvPages@Inventory@Pages@Twisted].SelectedItem.Text.Mid[10,100]}]
				break
				case INV_OPEN
				OpenList:Remove[${UIElement[lstListed@Items@InvPages@Inventory@Pages@Twisted].SelectedItem.Text.Mid[7,100]}]
				break		
			}
			This:UpdateItemsGUI
		}
 	...
 	method AddRestock()
 	{
 		if !${UIElement[lstInventory@Restock@InvPages@Inventory@Pages@Twisted].SelectedItem(exists)}
 		{
 			return
 		}
 		RestockList:Set[${UIElement[lstInventory@Restock@InvPages@Inventory@Pages@Twisted].SelectedItem.Text},${UIElement[lstInventory@Restock@InvPages@Inventory@Pages@Twisted].SelectedItem.Text},${UIElement[cmbMinAmount@Restock@InvPages@Inventory@Pages@Twisted].SelectedItem.Text},${UIElement[cmbMaxAmount@Restock@InvPages@Inventory@Pages@Twisted].SelectedItem.Text},${UIElement[cmbType@Restock@InvPages@Inventory@Pages@Twisted].SelectedItem.Text}]
 	...
 	method RemoveRestock()
 	{
 		...
 		RestockList:Erase[${UIElement[lstListed@Restock@InvPages@Inventory@Pages@Twisted].SelectedItem.Text}]
 		This:UpdateRestockGUI
 	}
 	method UpdateRestockGUI()
 	{
 		...
 		UIElement[lstListed@Restock@InvPages@Inventory@Pages@Twisted]:ClearItems
 		UIElement[lstInventory@Restock@InvPages@Inventory@Pages@Twisted]:ClearItems
 		
 		for(i:Set[1];${i} <= ${list.Count};i:Inc)
 		{
 			if !${RestockList.Element[${list.Object[${i}].Name}](exists)}
			{	
	 			UIElement[lstInventory@Restock@InvPages@Inventory@Pages@Twisted]:AddItem[${list.Object[${i}].Name}]
	 		}
	 	}
	 	RestockList:GetIterator[iter]
	 	iter:First
	 	while ${iter.IsValid}
	 	{
	 		UIElement[lstListed@Restock@InvPages@Inventory@Pages@Twisted]:AddItem[${iter.Key}]
	 		iter:Next
	 	}
	}	
	method RestockSettingUpdate()
 	{
 		variable string theItem = ${UIElement[lstListed@Restock@InvPages@Inventory@Pages@Twisted].SelectedItem.Text}
 		variable int id
 		
 		id:Set[${UIElement[cmbMinAmount@Restock@InvPages@Inventory@Pages@Twisted].ItemByText[${RestockList.Element[${theItem}].Min}].ID}]
		UIElement[cmbMinAmount@Restock@InvPages@Inventory@Pages@Twisted]:SetSelection[${id}]
 		id:Set[${UIElement[cmbMaxAmount@Restock@InvPages@Inventory@Pages@Twisted].ItemByText[${RestockList.Element[${theItem}].Max}].ID}]
		UIElement[cmbMaxAmount@Restock@InvPages@Inventory@Pages@Twisted]:SetSelection[${id}]		
		id:Set[${UIElement[cmbType@Restock@InvPages@Inventory@Pages@Twisted].ItemByText[${RestockList.Element[${theItem}].myType}].ID}]
		UIElement[cmbType@Restock@InvPages@Inventory@Pages@Twisted]:SetSelection[${id}]
