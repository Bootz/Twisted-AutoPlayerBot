...
objectdef oRecord inherits cBase
{
	...
	{
		variable string ID
		ID:Set[${UIElement[tlbQuests@Quest@HumanPages@Human@Pages@Twisted].SelectedItem}]
		ID:Set[${ID.Token[2,#]}]
		...
		else
		{
			if ${Quest.QuestIsLogged[${Name}]}
			{
				...
				if ${IsEnd}
				{
					...
					if ${UIElement[chkRecordQuest@Quest@HumanPages@Human@Pages@Twisted].Checked}
					{
...
objectdef oPlay inherits cBase
{
	...
	method PopulateQuests()
	{
		...
		UIElement[tlbQuests@Quest@HumanPages@Human@Pages@Twisted]:ClearItems
		...
		if ${QuestIterator:First(exists)}
		{
			do
			{
				...
				{
					UIElement[tlbQuests@Quest@HumanPages@Human@Pages@Twisted]:AddItem["(${QuestLevel}) ${QuestName} #${QuestIterator.Key}"]
				}
			}
	...
	{
		variable string ID
		if ${UIElement[tlbQuests@Quest@HumanPages@Human@Pages@Twisted].SelectedItem(exists)}
		{
			ID:Set[${UIElement[tlbQuests@Quest@HumanPages@Human@Pages@Twisted].SelectedItem}]
			ID:Set[${ID.Token[2,#]}]
			UIElement[txtQuestString@Quest@HumanPages@Human@Pages@Twisted]:SetText[(${LavishSettings[Quests].FindSet[${ID}].FindSetting[Level]}) ${LavishSettings[Quests].FindSet[${ID}].FindSetting[Name]} ID: ${ID}]
			UIElement[txtQuestArea@Quest@HumanPages@Human@Pages@Twisted]:SetText[${LavishSettings[Quests].FindSet[${ID}].FindSetting[Area]}]
			UIElement[txtQuestType@Quest@HumanPages@Human@Pages@Twisted]:SetText[${LavishSettings[Quests].FindSet[${ID}].FindSetting[Type]}]
			UIElement[txtQuestItem@Quest@HumanPages@Human@Pages@Twisted]:SetText[${LavishSettings[Quests].FindSet[${ID}].FindSetting[Item]}]
			UIElement[txtQuestWeight@Quest@HumanPages@Human@Pages@Twisted]:SetText[${LavishSettings[Quests].FindSet[${ID}].FindSetting[Weight]}]
			UIElement[txtQuestFaction@Quest@HumanPages@Human@Pages@Twisted]:SetText[${LavishSettings[Quests].FindSet[${ID}].FindSetting[Faction]}]
		}
	}
